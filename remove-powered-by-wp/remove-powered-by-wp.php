...
/* translators: link to plugin installer, theme name */
            ...
            } elseif (in_array(get_template(), array('generatepress'))) {

                $description = __('Removes the "Built with" text displayed in the website footer and replaces with the content of the "Site Info" widget area.', 'remove-powered-by-wp');
...
<?php
                    ...
                    case 'generatepress':
                        ...
                        add_action('generate_credits', array($this, 'rpbw_get_site_info_sidebar'));
